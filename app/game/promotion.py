...
class PromotionManager:
    ...
    #
    # If pawn is on the end of board and should be promoted
    # method sets self._to_promote = piece
    #
    ...
    #
    # If self._to_promote is not None and model is in self._possible types
    # it returns tuple containing new created piece
    #
    def try_to_promote(self, model: PieceModel) -> tuple[Piece, PieceMovement] | None:
